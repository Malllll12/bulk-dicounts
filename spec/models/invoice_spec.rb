...
RSpec.describe Invoice, type: :model do
  ...
  describe '#discounted_revenue' do
    xit 'returns discounted revenue' do
      ...
      actual = invoice.discounted_revenue
      # undiscounted = 1600
      expected = 1400

      expect(actual).to eq(expected)
    end
    xit 'should not return discount revenue if threshold is not met' do
      merchant = Merchant.create!(name: 'Shop Here')
      not_included_merchant = Merchant.create!(name: 'Dont Shop Here')
      customer = Customer.create!(first_name: 'Joey', last_name: 'Ondricka')
      item_1 = Item.create!(merchant_id: merchant.id, name: 'widget-1', description: 'widget description',
    ...
    xit 'should apply multiple discounts if threshold is met' do
      merchant = Merchant.create!(name: 'Shop Here')
      not_included_merchant = Merchant.create!(name: 'Dont Shop Here')
      customer = Customer.create!(first_name: 'Joey', last_name: 'Ondricka')
      item_1 = Item.create!(merchant_id: merchant.id, name: 'widget-1', description: 'widget description',
    ...
    xit 'should apply best discount' do
      merchant = Merchant.create!(name: 'Shop Here')
      not_included_merchant = Merchant.create!(name: 'Dont Shop Here')
      customer = Customer.create!(first_name: 'Joey', last_name: 'Ondricka')
      item_1 = Item.create!(merchant_id: merchant.id, name: 'widget-1', description: 'widget description',
    ...
    xit 'should return total_revenue if discounted_revenue is not valid' do
      merchant = Merchant.create!(name: 'Shop Here')
      not_included_merchant = Merchant.create!(name: 'Dont Shop Here')
      customer = Customer.create!(first_name: 'Joey', last_name: 'Ondricka')
      item_1 = Item.create!(merchant_id: merchant.id, name: 'widget-1', description: 'widget description',
